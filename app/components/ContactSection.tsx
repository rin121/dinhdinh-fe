          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">0911576548</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">kduy121@gmail.com</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">805 Tân Xuân - Hàm Tân - Bình Thuận</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <a href="https://zalo.me/0911576548" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-white hover:bg-blue-600 transition-colors p-2">
                ...
                <a href="https://www.facebook.com/chautrang121" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-colors p-2">
